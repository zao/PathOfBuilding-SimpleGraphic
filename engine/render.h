...
public:
	...
	virtual r_shaderHnd_c* RegisterShader(std::u8string_view name, int flags) = 0;
	...
	virtual void	DrawString(float x, float y, int align, int height, const col4_t col, int font, std::string_view str) = 0;
